...
def prepare_nn_training_data(
    df: pd.DataFrame, target: str, opts: options.TrainOptions, return_dataframe: bool = False
...
def build_fnn_network(
    input_size: int, opts: options.TrainOptions, output_bias=None
) -> Model:
...
def define_single_label_model(
    ...
    Args:
        ...
        opts (options.TrainOptions): The options used in the model.
